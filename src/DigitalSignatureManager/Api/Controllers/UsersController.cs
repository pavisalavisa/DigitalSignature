...
namespace Api.Controllers
{
    ...
    public class UsersController : BaseController
    {
        ...
        public async Task<ActionResult<EntityCreatedModel>> PostRegistration(RegisterUserModel model, [FromServices] IRegisterUserCommand command)
        {
        ...
        public async Task<ActionResult<PagingResultModel<IdNameModel>>> Get([FromQuery] PagingQueryModel pagingModel, [FromServices] IGetAllUsersQuery query)
        {
